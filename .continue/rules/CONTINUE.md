...
1. Any file with `needs-review` will be flagged with an admonition in the very top of the page, in the language of the page:

         /// warning | Translation Status
         This translation was generated by AI and **needs human review**.
         Please verify the content for accuracy and fluency.
         ///
