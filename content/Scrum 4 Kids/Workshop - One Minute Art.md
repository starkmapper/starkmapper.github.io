# Scrum 4 Kids Workshop: One Minute Art
...
1. Creating a minimal set of rules (3 max)
...
1. Remind participants of the timebox, and playfully create a sense of urgency for delivery (like it's a fun game-show, but with awesome learning sprinkled on top).
1. When the timebox expires, invite participants to present why they believe they made a step towards the intermediate goal. Ask the beneficiary for specific feedback on the drawing regarding the common goal. You can ask questions like:
    1. Is this what you had envisioned?
    1. What's the one thing that delights you, and why?
    1. What could you do without, and why?
    1. Invite participants to ask questions and come up with concrete next steps.
1. Ask participants to share their experience compared to round 2. You can use questions like:
    1. What changed by having a clear goal?
    1. Which rule did you find most helpful?
1. In their groups, ask participants to formulate 2 ways to improve collaboration:
...
1. Invite groups to present their intergroup ideas. For every idea ask two questions:
    ...
    1. How can we make this actionable?
1. Have participants pick one intergroup improvement idea to put into practice for the next round. Use (dot) voting if you have a large group.
...
1. Hang a fresh large paper next to the drawings. Divide it into two sections: "Group" and "Individual".
1. Invite participants to reflect on where we started, and how for we've come in a relatively short time. Use a Liberating Structure like [1-2-4-all] for large groups. Collect take aways while collectively looking for patterns. Write them down so you can put them on the "Group" section.
1. Ask participants to write down one thing they have learned today, and how they will start to apply it tomorrow. Invite participants to share them, use a Liberating Structure like [1-2-4-all] or [Impromptu Networking] in large groups.
